...
```java
import io.github.ciprianlocalpulse.kitfiscal.KitFiscalClient;
...
`io.github.ciprianlocalpulse.kitfiscal.exception.KitFiscalApiException` (unchecked), cu
...
`io.github.ciprianlocalpulse.kitfiscal.internal.Json` acoperă exact ce produce FastAPI/Pydantic
